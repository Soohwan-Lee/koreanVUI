...
with open("./code/demo/kakao_code.json", "r") as fp:
    tokens = json.load(fp)    
# print(tokens)
...
def send_message():
    ...
    template = {
        "object_type" : "list",
        "header_title" : "[LEMMY Test Message]",
        "header_link" : {
        ...
        "contents" : [
            {
                "title" : "1. 응급상황 감지 안내",
                "description" : "사용자의 응급상황이 감지되었습니다.",
...
livingRoomBulb = Bulb("192.168.1.211")
bedRoomBulb = Bulb("192.168.1.145")
