...
def main():
    ...
    args.wav_path = './resource/speechRecognition/wakeUpWordRecognition/audio.wav'
    args.model_path = './resource/speechRecognition/wakeUpWordRecognition/porcupine_params_ko.pv'
    args.keyword_paths =['./resource/speechRecognition/wakeUpWordRecognition/lemmyWakeUp_Mac.ppn']
    ...
    try:
        while True:
            ...
            if result >= 0:
                print("Detected 'Lemmy's Wake-Up'!!")
