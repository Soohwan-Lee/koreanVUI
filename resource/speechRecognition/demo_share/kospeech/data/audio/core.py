...
# extention의 default가 config/audio/fbank에서 pcm으로 되어 있어 수정하였다.
def load_audio(audio_path: str, del_silence: bool = False, extension='wav') -> np.ndarray:
    """
    ...
    try:
        ...
        """elif extension == 'wav' or extension == 'flac':
            ...
            signal, _ = librosa.load(audio_path, sr=48000) #수정함: 16000 -> 48000
            return signal"""
