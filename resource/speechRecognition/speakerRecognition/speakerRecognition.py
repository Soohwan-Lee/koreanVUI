...
def main():
    ...
    args.output_audio_path = './resource/speechRecognition/SpeakerRecognition/record.wav'
    # args.output_audio_path = '/Users/Soohwan/Desktop/Github/koreanVUI/resource/speechRecognition/speakerRecognition'
    args.audio_device_index = 0
    args.output_profile_path = './resource/speechRecognition/SpeakerRecognition/profile.txt'
    args.input_profile_paths = ['./resource/speechRecognition/SpeakerRecognition/profile.txt']
