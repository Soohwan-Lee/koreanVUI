...
# API keys and setup for voice recognition and processing
access_key = 'YOUR_API_KEY'
openai_api_key = 'YOUR_API_KEY'
keyword_paths = ['./resource/speechRecognition/speechRecognitionModule/lemmyWakeUp_ENG_MAC.ppn']
...
if __name__ == '__main__':
    pose_thread = Thread(target=pose_detection)
    voice_thread = Thread(target=main_voice_interaction)
